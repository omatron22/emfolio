...
export const shows: Show[] = [
  {
    ...
    year: "2026",
    director: "Eric Swartz",
    heroImage: "/portfolio/madforest/madforest1.jpg",
    images: [
      "/portfolio/madforest/madforest1.jpg",
      "/portfolio/madforest/madforest2.jpg",
      "/portfolio/madforest/madforest3.jpg",
      "/portfolio/madforest/madforest4.jpg",
      "/portfolio/madforest/madforest5.jpg",
      "/portfolio/madforest/madforest6.jpg",
      "/portfolio/madforest/madforest7.jpg",
      "/portfolio/madforest/madforest8.jpg",
      "/portfolio/madforest/madforest9.jpg",
      "/portfolio/madforest/madforest10.jpg",
      "/portfolio/madforest/madforest11.jpg",
      "/portfolio/madforest/madforest12.jpg",
    ],
    credits: [
      { role: "Playwright", name: "Caryl Churchill" },
      { role: "Director", name: "Eric Swartz" },
      { role: "Assistant Director", name: "Chelsea Silver" },
      { role: "Choreographer", name: "Keira Negrete" },
      { role: "Stage Manager", name: "Molly Wolflick" },
      { role: "Dramaturg", name: "Sydney Nadal" },
      { role: "Dialect Coach", name: "Mary Claire Garcia" },
      { role: "Intimacy Director", name: "Carly DW Bones" },
      { role: "Scenic & Projection Designer", name: "Sara Lowe" },
      { role: "Costume Designer", name: "Sean Hannah" },
      { role: "Lighting Designer", name: "Em Moore" },
      { role: "Sound Designer", name: "Everett Wall" },
    ],
  },
  {
    slug: "emma",
    title: "Emma: No One But Herself",
    production: "UCLA School of Theater, Film and Television",
    year: "2026",
    director: "Danielle Kay",
    heroImage: "/portfolio/emma/emma1.jpg",
    images: [
      "/portfolio/emma/emma1.jpg",
      "/portfolio/emma/emma2.jpg",
      "/portfolio/emma/emma3.jpg",
      "/portfolio/emma/emma4.jpg",
      "/portfolio/emma/emma5.jpg",
      "/portfolio/emma/emma6.jpg",
      "/portfolio/emma/emma7.jpg",
      "/portfolio/emma/emma8.jpg",
      "/portfolio/emma/emma9.jpg",
    ],
    credits: [
      { role: "Director", name: "Danielle Kay" },
      { role: "Music Director", name: "Dan Belzer" },
      { role: "Voice Director", name: "Jeremy Mann" },
      { role: "Stage Manager", name: "Antonia Yang" },
      { role: "Scenic Designer", name: "Cayla Baughns" },
      { role: "Lighting Designer", name: "Em Moore" },
      { role: "Assistant Lighting Designer", name: "Cristo Montanez" },
      { role: "Assistant Lighting Designer", name: "Kai Li" },
      { role: "Assistant Lighting Designer", name: "Grant Sapcharoenlert" },
      { role: "Costume Designer", name: "Taylor Aragon" },
      { role: "Sound Designer", name: "Lia Eacott" },
      { role: "Intimacy Director", name: "Carly DW Bones" },
      { role: "Dialect Coach", name: "Mary Claire Garcia" },
    ],
  },
