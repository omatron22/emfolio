  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-8">
        <h1 className="font-accent text-5xl md:text-7xl font-bold mb-4 text-white tracking-tight">
          Em Moore
        </h1>
        <h2 className="font-serif text-xl md:text-3xl text-white/90 mb-12 font-light tracking-wider">
        Lighting Design
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 max-w-4xl w-full">
          ...
          >
            <span className="font-accent text-xl font-medium block mb-2">
            Portfolio</span>
